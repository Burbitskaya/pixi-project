...
export class TileMap {
  ...
  constructor(
    ...
    this.walkableGids = new Set([
      5725, 6593, 6597, 6841, 8390, 8774, 5493, 2934, 2942, 6634, 3969,
    ]);
  ...
  isWalkable(col: number, row: number): boolean {
    if (
      col < 0 ||
      col >= this.groundLayer.width ||
      row < 0 ||
      row >= this.groundLayer.height
    )
      return false;
